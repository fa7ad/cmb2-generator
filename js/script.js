...
(function ( $ ) {
  ...
  $( document ).ready( function () {
    $( '#fields' ).on( 'click loadTrig', function () {
      ...
      var dropdown = $( this ), selected_option = dropdown.val(), form_elem = dropdown.parents( '.form-element' ), html_element = $( '#option-param-elem' ).children(), field_types = [ 'multicheck',
                                                                                                                                                                                        'multicheck_inline',
                                                                                                                                                                                        'radio',
                                                                                                                                                                                        'radio_inline',
